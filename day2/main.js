...
// let lcMessage = messagesFromDad.map(m => m.toLowerCase())
...
// EXCERCISE 1
//   let emailCompany = users.map(u=> {return {email: u.email, companyName: u.company.name}})

// EXCERCISE 2

// let zip5 = users.filter(u => u.address.zipcode[0]==5)
...
// const findByApt = apt => users.find(u =>u.address.suite === apt)

// console.log(findByApt("Apt. 950").company.name)
